...
public class SpaceBusters3DMidlet extends MIDlet implements CommandListener
{
    // we declare an instance of our Canvas (actually a GameCanvas!)
    private SpaceBusters3DCanvas mCanvas;
    ...
    public void startApp() 
    {
        ...
        {
            // create the canvas
            mCanvas = new SpaceBusters3DCanvas(Display.getDisplay(this));
