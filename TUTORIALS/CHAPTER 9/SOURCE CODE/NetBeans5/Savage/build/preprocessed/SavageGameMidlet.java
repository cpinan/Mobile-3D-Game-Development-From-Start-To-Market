...
public class SavageGameMidlet extends MIDlet implements CommandListener
{
    // we declare an instance of our Canvas (actually a GameCanvas!)
    private SavageGameCanvas mCanvas;
    ...
    public void startApp() 
    {
        ...
        {
            // create the canvas
            mCanvas = new SavageGameCanvas(Display.getDisplay(this));
