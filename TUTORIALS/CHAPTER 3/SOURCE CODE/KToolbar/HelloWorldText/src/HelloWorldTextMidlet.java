...
public class HelloWorldTextMidlet extends MIDlet implements CommandListener
{
    // we declare an instance of our Canvas (actually a GameCanvas!)
    private HelloWorldTextCanvas mCanvas;
    ...
    public void startApp() 
    {
        ...
        {
            // create the canvas
            mCanvas = new HelloWorldTextCanvas(Display.getDisplay(this));
