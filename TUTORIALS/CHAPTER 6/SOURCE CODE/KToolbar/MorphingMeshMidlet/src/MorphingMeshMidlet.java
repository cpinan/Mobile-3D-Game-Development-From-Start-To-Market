...
public class MorphingMeshMidlet extends MIDlet implements CommandListener
{
    // we declare an instance of our Canvas (actually a GameCanvas!)
    private MorphingMeshCanvas mCanvas;
    ...
    public void startApp() 
    {
        ...
        {
            // create the canvas
            mCanvas = new MorphingMeshCanvas(Display.getDisplay(this));
